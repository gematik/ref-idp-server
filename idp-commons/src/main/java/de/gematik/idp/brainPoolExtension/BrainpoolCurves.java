...
public class BrainpoolCurves {
  ...
  private static final ECNamedCurveParameterSpec EC_NAMED_CURVE_PARAMETER_SPEC_BP256R1 =
      ECNamedCurveTable.getParameterSpec("brainpoolP256r1");
  private static final ECNamedCurveParameterSpec EC_NAMED_CURVE_PARAMETER_SPEC_BP384R1 =
      ECNamedCurveTable.getParameterSpec("brainpoolP384r1");
  private static final ECNamedCurveParameterSpec EC_NAMED_CURVE_PARAMETER_SPEC_BP512R1 =
      ECNamedCurveTable.getParameterSpec("brainpoolP512r1");
  private static final ECParameterSpec EC_PARAMETER_SPEC_BP256R1 =
      new ECNamedCurveSpec(
          "brainpoolP256r1",
          EC_NAMED_CURVE_PARAMETER_SPEC_BP256R1.getCurve(),
          EC_NAMED_CURVE_PARAMETER_SPEC_BP256R1.getG(),
          EC_NAMED_CURVE_PARAMETER_SPEC_BP256R1.getN(),
          EC_NAMED_CURVE_PARAMETER_SPEC_BP256R1.getH(),
  ...
  private static final ECParameterSpec EC_PARAMETER_SPEC_BP384R1 =
      new ECNamedCurveSpec(
          "brainpoolP384r1",
          EC_NAMED_CURVE_PARAMETER_SPEC_BP384R1.getCurve(),
          EC_NAMED_CURVE_PARAMETER_SPEC_BP384R1.getG(),
          EC_NAMED_CURVE_PARAMETER_SPEC_BP384R1.getN(),
          EC_NAMED_CURVE_PARAMETER_SPEC_BP384R1.getH(),
  ...
  private static final ECParameterSpec EC_PARAMETER_SPEC_BP512R1 =
      new ECNamedCurveSpec(
          "brainpoolP512r1",
          EC_NAMED_CURVE_PARAMETER_SPEC_BP512R1.getCurve(),
          EC_NAMED_CURVE_PARAMETER_SPEC_BP512R1.getG(),
          EC_NAMED_CURVE_PARAMETER_SPEC_BP512R1.getN(),
          EC_NAMED_CURVE_PARAMETER_SPEC_BP512R1.getH(),
  ...
  private static void addCurve(final String name, final ECParameterSpec spec) {
    try {
      final Method method =
          EllipticCurves.class.getDeclaredMethod("addCurve", String.class, ECParameterSpec.class);
