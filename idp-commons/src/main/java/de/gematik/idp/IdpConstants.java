...
public final class IdpConstants {
    ...
    public static final String AUDIENCE_EREZEPT = "https://erp.telematik.de/login";
    public static final String AUDIENCE_PAIRING = "https://idp-pairing-test.zentral.idp.splitdns.ti-dienste.de";
