...
public class AccessTokenBuilder {
  ...
  public JsonWebToken buildAccessToken(final JsonWebToken authenticationToken) {
    ...
    final String clientId =
        authenticationToken
            ...
            .orElseThrow(
                () ->
                    new RequiredClaimException("Unable to obtain " + CLIENT_ID.getJoseName() + "!"))
            .toString();
    ...
    claimsMap.put(
        ...
        buildSubjectClaim(
            ...
            authenticationToken
                ...
                .orElseThrow(
                    () ->
                        new RequiredClaimException(
                            "Missing '" + ID_NUMBER.getJoseName() + "' claim!")),
            serverSubjectSalt));
  ...
  private String determineAudienceBasedOnScope(final Set<String> scopesBodyClaim) {
    ...
    if (audienceUrls.size() == 1) {
      ...
      throw new IdpRuntimeException(
          "Could not determine Audience for scopes '" + scopesBodyClaim + "'");
    }
  }
