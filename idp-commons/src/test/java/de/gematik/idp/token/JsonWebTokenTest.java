...
public class JsonWebTokenTest {
    ...
    public void getStringBodyClaims_shouldMatch() {
        ...
        Assertions.assertThat(jsonWebToken.getStringBodyClaim("foo"))
                .get()
                .isEqualTo("bar");
    }
    ...
    public void getDateTimeBodyClaims_shouldMatch() {
        ...
        final JsonWebToken jsonWebToken = idpJwtProcessor.buildJwt(JwtDescription.builder()
                .claims(Map.of("foo", now.toEpochSecond()))
                .build());

        Assertions.assertThat(jsonWebToken.getDateTimeBodyClaim("foo"))
