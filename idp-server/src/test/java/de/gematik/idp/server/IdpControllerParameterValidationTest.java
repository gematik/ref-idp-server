...
import static de.gematik.idp.error.IdpErrorType.*;
...
public class IdpControllerParameterValidationTest {
    ...
    public void getAccessToken_wrongCodeVerifier_shouldGiveError() {
        ...
        final String keyVerifierPayload = IdpJwe
            .createWithPayloadAndEncryptWithKey(claims.toJson(),
        ...
        assertErrorResponseMatches(
            ...
            3000, INVALID_GRANT, "code_verifier stimmt nicht mit code_challenge überein");
    }
    ...
    public void getAccessToken_missingClaimsInAuthCode_shouldGiveError() {
        final String alteredAuthToken = new JwtBuilder()
            ...
            .buildJwt().encrypt(symmetricEncryptionKey)
            .getRawString();
        assertErrorResponseMatches(
