...
public class KeyInformationController {
    ...
    public IdpJwksDocument getAuthJwks() {
        return authKey.buildJwks();
    }
    ...
    public IdpJwksDocument getTokenJwks() {
    ...
    public IdpJwksDocument getDiscJwks() {
        return discKey.buildJwks();
    }
}
