...
Feature: Registrierung für Alternative Authentisierung am IDP Server
  ...
  Wir löschen vor den Tests alle evt. vorhandenen Pairings die danach angelegt werden sollen.
    ...
    Examples: Zu deregistrierende Daten
      | auth_cert                                       | key_id             |
      | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 | keyident001allow   |
      | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 | keyident001unknown |
      | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 | keyident002        |
      | /certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12 | keyident002        |
      | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 | keyident003        |
      | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 | keyident004        |
      | /certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12 | keyident004        |
      | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 | keyidinvamr01      |
      | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 | keyidinvamr02      |
  ...
  Scenario: AltAutReg - Gutfall - Zwei Pairings mit identem Identifier und Pub SE Auth aber unterschiedlicher IdNummer
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyident002    | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I request an pairing access token with eGK cert '/certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12'
    And IDP I create a device information token with
      | name       | manufacturer | product     | model | os      | os_version |
      | eRezeptApp | Fair Phone   | FairPhone 3 | F3    | Android | 1.0.2 f    |
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyident002    | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12'
    Then the response status is 200
    And IDP the JSON response should match
        """
          {
  ...
  Scenario: AltAutReg - Gutfall - Zwei Pairings mit unterschiedlichem key identifier und unterschiedlicher IDNummer
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyident003    | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I request an pairing access token with eGK cert '/certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12'
    And IDP I create a device information token with
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyident004    | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-b-valid-ecc-2.p12'
    Then the response status is 200
    And IDP the JSON response should match
  ...
  Scenario: AltAutReg - Zweifacher Eintragungsversuch Idente Daten
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier   | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidentdoppel01 | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
  ...
  Scenario: AltAutReg - Zweifacher Eintragungsversuch Devicedaten unterschiedlich
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier   | product | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidentdoppel02 | GOTA 1  | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier   | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidentdoppel02 | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    Then IDP the response is an 409 error with gematik code 4004 and error "invalid_request"
  ...
  Scenario: AltAutReg - Zweifacher Eintragungsversuch alles bis auf key identifier und Zertifikat unterschiedlich
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier   | product | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidentdoppel03 | GOTA 1  | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I request an access token
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier   | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidentdoppel03 | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    Then IDP the response is an 409 error with gematik code 4004 and error "invalid_request"
  ...
  Scenario Outline: AltAutReg - Unterschiedliche Zertifikate mit unterschiedlicher IDNummer in Verwendung
    ...
    Examples: Liste mit Einträgen wo immer ein Zertifikat mit anderer IDNummer unterschiedlich aber gültig ist
     ...
     # | 400    | invalid_parameter_value | -1    | keyidentdiffcert01 | egk-idp-idnumber-a-folgekarte-ecc-2.p12 | Pub_Se_Aut-1.pem | egk-idp-idnumber-a-valid-ecc-2.p12 | egk-idp-idnumber-a-valid-ecc-2.p12 | egk-idp-idnumber-a-valid-ecc-2.p12 |
      ...
      | 403    | access_denied | 4001  | keyidentdiffcert05 | egk-idp-idnumber-a-valid-ecc-2.p12 | Pub_Se_Aut-1.pem | egk-idp-idnumber-a-valid-ecc-2.p12 | egk-idp-idnumber-a-valid-ecc-2.p12 | egk-idp-idnumber-b-valid-ecc-2.p12 |
  ...
  Scenario Outline: AltAutReg - Null Werte in device info
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier  | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | <keyidentifier> | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
  ...
  Scenario Outline: AltAutReg - Null Werte in pairing data
    ...
    Examples: AltAutReg - Null Pairing Data Beispiele
      ...
      | keyidentnull11 | $NULL                        | FairPhone 3 | 419094927676993 | Android | 1893456000 | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
      | keyidentnull13 | /keys/valid/Pub_Se_Aut-1.pem | $NULL       | 419094927676993 | Android | 1893456000 | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
      | keyidentnull14 | /keys/valid/Pub_Se_Aut-1.pem | FairPhone 3 | $NULL           | Android | 1893456000 | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
      | keyidentnull15 | /keys/valid/Pub_Se_Aut-1.pem | FairPhone 3 | 419094927676993 | $NULL   | 1893456000 | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
      | keyidentnull16 | /keys/valid/Pub_Se_Aut-1.pem | FairPhone 3 | 419094927676993 | Android | $NULL      | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
  ...
  Scenario Outline: AltAutReg - Fehlende Werte in pairing data
    ...
    Examples: AltAutReg - Fehlende Pairing Data Beispiele
      | keyidentifier    | key_data                     | product     | serialnumber    | issuer  | not_after  | public_key                                      |
      | keyidentremove11 | $REMOVE                      | FairPhone 3 | 419094927676993 | Android | 1893456000 | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
      | keyidentremove13 | /keys/valid/Pub_Se_Aut-1.pem | $REMOVE     | 419094927676993 | Android | 1893456000 | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
      | keyidentremove14 | /keys/valid/Pub_Se_Aut-1.pem | FairPhone 3 | $REMOVE         | Android | 1893456000 | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
      | keyidentremove15 | /keys/valid/Pub_Se_Aut-1.pem | FairPhone 3 | 419094927676993 | $REMOVE | 1893456000 | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
      | keyidentremove16 | /keys/valid/Pub_Se_Aut-1.pem | FairPhone 3 | 419094927676993 | Android | $REMOVE    | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
  ...
  Scenario Outline: AltAutReg - Ungültige Zertifikate (selfsigned, outdated, revoced)
    ...
    Examples: AltAutReg - Ungültige Zertifikate
      ...
      | keyidentinvcert02 | /certs/invalid/egk-idp-idnumber-a-invalid-issuer-2.p12 |
      | keyidentinvcert03 | /certs/invalid/egk-idp-idnumber-a-revoked-ecc-2.p12    |
  ...
  Scenario Outline: AltAutReg - Registriere Pairing mit Zertifikat ohne IDNummer
    ...
    Examples: Liste mit Einträgen wo immer ein Zertifikat ohne IdNummer verwendet wird
      | status | errcode       | errid | key_identifier | cert_access                        | cert_keydata     | cert_public_key                     | cert_sign                           | cert_register                       |
      | 403    | access_denied | 4001  | keyidentnoid03 | egk-idp-idnumber-a-valid-ecc-2.p12 | Pub_Se_Aut-1.pem | egk-idp-idnumber-missing1-ecc-2.p12 | egk-idp-idnumber-a-valid-ecc-2.p12  | egk-idp-idnumber-a-valid-ecc-2.p12  |
      | 403    | access_denied | 4001  | keyidentnoid04 | egk-idp-idnumber-a-valid-ecc-2.p12 | Pub_Se_Aut-1.pem | egk-idp-idnumber-a-valid-ecc-2.p12  | egk-idp-idnumber-missing1-ecc-2.p12 | egk-idp-idnumber-a-valid-ecc-2.p12  |
      | 403    | access_denied | 4001  | keyidentnoid05 | egk-idp-idnumber-a-valid-ecc-2.p12 | Pub_Se_Aut-1.pem | egk-idp-idnumber-a-valid-ecc-2.p12  | egk-idp-idnumber-a-valid-ecc-2.p12  | egk-idp-idnumber-missing1-ecc-2.p12 |
  ...
  Scenario: AltAutReg - Pairing mit veraltetem Access Token wird abgelehnt
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidentacc001 | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
  ...
  Scenario: AltAutReg - Zugriff mit ACCESS_TOKEN von signierter Challenge mit falschem Scope (erezept)
    Given IDP I request an erezept access token with eGK cert '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidentacc002 | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    Then IDP the response is an 403 error with gematik code 4001 and error 'access_denied'
  ...
  Scenario: AltAutReg - Zugriff mit ACCESS_TOKEN via SSO Token mit falschem Scope (erezept)
    Given IDP I request an erezept access token via SSO token with eGK cert '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidentacc003 | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    Then IDP the response is an 403 error with gematik code 4001 and error 'access_denied'
  ...
  Scenario Outline: AltAutReg - Registriere ein Pairing mit falschen Versionen
    ...
    And IDP I create pairing data with
      ...
      | <versionPairingData> | /keys/valid/Pub_Se_Aut-1.pem | <keyid>        | ES256                          | FairPhone 3 | 419094927676993 | Android | 1893456000 | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12' and version '<versionReg>'
    Then IDP the response is an 403 error with gematik code 4001 and error 'access_denied'
  ...
  Wir fordern mit alternativer Auth einen Access Token an, und benutzen diesen für eine weitere Registrierung. Das muss abgelehnt werden, weil AMR != SC, PIN
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidinvamr01  | FairPhone 3 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    ...
    And IDP I create authentication data with
      ...
      | ${TESTENV.pairing_version}  | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 | keyidinvamr01  | ["mfa", "hwk", "kba"] |
    ...
    And IDP I create pairing data with
      | se_subject_public_key_info   | key_identifier | product     | serialnumber    | issuer          | not_after       | auth_cert_subject_public_key_info               |
      | /keys/valid/Pub_Se_Aut-1.pem | keyidinvamr02  | FairPhone 4 | $FILL_FROM_CERT | $FILL_FROM_CERT | $FILL_FROM_CERT | /certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12 |
    And IDP I sign pairing data with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    And IDP I register the device with '/certs/valid/egk-idp-idnumber-a-valid-ecc-2.p12'
    Then IDP the response is an 403 error with gematik code 4001 and error 'access_denied'
