...
Feature: Authentisierung am Fachdienst
  ...
  @Approval
  Scenario: FD IDP Auth - Gutfall - Authentisierung am Auth-Endpunkt des FD
  ...
  - die Parameter client_id und request_uri enthalten
    ...
    Given IDP I send an authorization request to fachdienst with
    ...
    And IDP the response http headers match
        ...
        Location=http.*
        """
#    And IDP the response URI exists with param 'client_id' and value 'TODO hier die richtige client_id'
#    And IDP the response URI exists with param 'request_uri' and value 'TODO hier die richtige request_uri'
