...
public interface ContextKey {
  ...
  String CUCUMBER_REGEX =
      "(RESPONSE|CLAIMS|HEADER_CLAIMS|DISC_DOC|CHALLENGE|USER_CONSENT"
          ...
          + "|REDIRECT_URI|PUK_DISC|PUK_SIGN|PUK_ENC"
  ...
  String[] ENCRYPTED_KEYS = new String[] {SSO_TOKEN_ENCRYPTED, TOKEN_CODE_ENCRYPTED};
}
